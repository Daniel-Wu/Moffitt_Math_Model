...
%New things:
%explicit abiraterone quantity
%Continuous dosing of abi
%more continuous/smooth K function, that is drug adjusted
%More data-tracking stuff
%Hard shut-off for simulation time
%Fancy function and it's derivative to model resistance developments
...
kPreLup = kInitPreLup;
r_max  = [0.005 0.002 0.001];
r_min = [0.001 0.001 0.001];
r = [0 0 0];
...
doceDose = 0.5;
doceDecay = 0.05;
doceTreatTIPorp = 0.3; %Porportion of TI at which to give doce.
doceDoseWait = 500;
