...
while true
    ...
    while PSA<PSA_GiveAbi || treatedOnce          %While we are off abi
...
%         end
    ...
    while PSA>PSA_StopAbi  && ~treatedOnce          %Until we can reach that brightline, we treat
