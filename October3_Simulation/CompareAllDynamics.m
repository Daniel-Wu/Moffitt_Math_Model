...
smoothedTplus = all_x(44000:48000, 1);
smoothedTp = all_x(44000:48000, 2);
smoothedTminus = all_x(44000:48000, 3);
...
set(AX(1), 'xlim', [0 3000], 'ylim', [-100 300], 'FontSize', 24);
set(AX(2), 'xlim', [0 3000], 'ylim', [40 90], 'FontSize', 24);
